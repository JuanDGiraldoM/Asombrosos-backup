// var balloons=document.getElementsByClassName("balloon");
    ...
    var i=0;
    for(i=0; i<9;i++){
        document.getElementById("container").insertAdjacentHTML( 'beforeend',"<img class='balloon' id='purpleBalloon' src='img/balMorado.png'/>");
        document.getElementById("container").insertAdjacentHTML( 'beforeend',"<img class='balloon' id='greenBalloon' src='img/balVerde.png'/>");
        document.getElementById("container").insertAdjacentHTML( 'beforeend',"<img class='balloon' id='pinkBalloon' src='img/balRosa.png'/>");
    }
